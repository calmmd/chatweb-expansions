export default {
  ...
  mj:{
    ...
    ,infoStar:'此项使用固定API调用，请移步 <a  class="text-blue-600 dark:text-blue-500" href="https://api.expansion.chat/" target="_blank"> Expansion次元API中转 </a>获取token令牌，然后输入即可使用本产品</p><p>如果有问题请联系QQ 1042445597，谢谢！'
    ,setBtSaveChat:'仅保存会话'
    ,setBtSaveSys: '保存至系统'
